...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <spring:theme code="jquery.ui.javascript.file" var="jqueryUIJavascriptFile" text="" />
    <script type="text/javascript" src="<c:url value="${jqueryUIJavascriptFile}" />"></script>
    <%-- 
    ...
    --%>
    <spring:theme code="javacript_debug.ba_debug.file" var="javascriptDebugFile" text="" />
    <script type="text/javascript" src="<c:url value="${javascriptDebugFile}" />"></script>
